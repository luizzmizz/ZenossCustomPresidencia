...
class Page(HTMLParser):
    ...
    def mail(self):
        ...
        if self.csv is not None:
            ...
            baseurl = 'http://prbrpresidl07:8080'
            txt = MIMEText('<html><head><link rel="stylesheet" type="text/css" href="'+baseurl+'/++resource++extjs/resources/css/ext-all.css" /><link rel="stylesheet" type="text/css" href="'+baseurl+'/++resource++extjs/treegrid/treegrid.css" /><link rel="stylesheet" type="text/css" href="'+baseurl+'/++resource++zenui/js/livegrid/resources/css/ext-ux-livegrid.css" /><link rel="stylesheet" type="text/css" href="'+baseurl+'/++resource++zenui/css/xtheme-zenoss.css" /><link rel="stylesheet" type="text/css" href="'+baseurl+'/++resource++zenui/css/zenoss.css" /><link rel="stylesheet" type="text/css" href="'+baseurl+'/++resource++zenui/css/zenui3.css" /></head><body>'+ ''.join(self.html) + '</body></html>','html')
